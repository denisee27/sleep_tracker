                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${formatDuration(monthSleep!.averageDuration!.result!)}",
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Wrap(
                                            children: [
                                              Text(
                                                formatDuration(monthSleep!.totalDuration!.result!),
                                                style: TextStyle(fontWeight: FontWeight.w500, color: Colors.white),
                                              ),
                                            ],
                                          ),
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${DateFormat("HH:mm").format(monthSleep!.averageSleep!.averageTime!)}",
                                            style: TextStyle(fontWeight: FontWeight.w500, color: Colors.white),
                                          ),
                                        ],
                                      ),
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${DateFormat('HH:mm').format(monthSleep!.averageWake!.averageTime!)}",
                                            style: TextStyle(fontWeight: FontWeight.w500, color: Colors.white),
                                          )
                                        ],
                                      ),
                    ...
                    child: SfCartesianChart(
                        ...
                        series: <ChartSeries<ChartDuration, dynamic>>[
                          ColumnSeries<ChartDuration, dynamic>(
                              dataSource: monthSleep!.chartDuration!,
